...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
        ...
        <div className={layout.sectionInfo}>
          ...
          Lako upravljajte svojim <br className="sm:block hidden"/> obračunom i fakturisanjem.
          </h2>
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Budite prvi koji ce se pokazati u najnovijem svetlu i zablistati uz pomoc nasih novih kartica!
          </p>
